...
export const Button: React.FC<ButtonProps> = ({
  ...
  const variants = {
    primary: "bg-indigo-500 hover:bg-indigo-600 text-white shadow-lg shadow-indigo-500/30 hover:shadow-indigo-500/40",
    secondary: "bg-white border border-zinc-200 hover:bg-zinc-50 text-zinc-900 hover:border-zinc-300 shadow-sm",
    danger: "bg-red-500 hover:bg-red-600 text-white shadow-lg shadow-red-500/30",
    ghost: "bg-transparent hover:bg-zinc-100 text-zinc-900 hover:text-indigo-500",
  };
