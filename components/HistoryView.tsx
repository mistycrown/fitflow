      ...
      <div className="flex-1 overflow-y-auto">
        <div className="grid grid-cols-7 auto-rows-fr">
            {generateCalendar().map((day, idx) => {
                if (!day) {
                    return <div key={idx} className="bg-zinc-50/20 border-b border-r border-zinc-100 min-h-[90px]"></div>;
                }
                ...
                return (
                    <div 
                       ...
                       className={`
                          border-b border-r border-zinc-100 p-1 min-h-[90px] flex flex-col relative cursor-pointer hover:bg-zinc-50 transition-colors
